...
// Helper local: libera args y sale por error liberando también la pila
...
// Acepta múltiples argumentos; cada argv[i] puede contener uno o varios números separados por espacios
